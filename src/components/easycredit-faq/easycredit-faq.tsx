...
export class EasycreditFaq {
  ...
  getBillFaq() {
    return [
      <easycredit-accordion>
        <easycredit-accordion-item>
          <h3 slot="title">Was ist easyCredit-Rechnung?</h3>
          <div>
        ...
        <easycredit-accordion-item>
          <h3 slot="title">Wer kann mit easyCredit-Rechnung abschließen?</h3>
          <div>
        ...
        <easycredit-accordion-item>
          <h3 slot="title">Welche Einkaufsbeträge sind bei easyCredit-Rechnung möglich?</h3>
          <div>
        ...
        <easycredit-accordion-item>
          <h3 slot="title">Wann wird der Kaufbetrag abgebucht?</h3>
          <div>
        ...
        <easycredit-accordion-item>
          <h3 slot="title">Ist eine vorzeitige Zahlung des Kaufbetrags möglich?</h3>
          <div>
        ...
        <easycredit-accordion-item>
          <h3 slot="title">Hat die Ablehnung meines Zahlungswunschs Einfluss auf weitere Bestellungen?</h3>
          <div>
            Nein, Ihr Produktwunsch wird immer individuell geprüft, sodass eine spätere Entscheidung durchaus positiv ausfallen kann.
          </div>
        </easycredit-accordion-item>
