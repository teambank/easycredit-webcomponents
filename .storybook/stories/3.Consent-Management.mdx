...
Sollen die Web Components vorbehaltlich der Zustimmung des Kunden eingefügt werden, muss darauf geachtet werden, dass die Komponenten als ESM-Modul eingebunden werden. Im folgenden zeigen wir eine Möglichkeit, wie die Komponenten in Verbindung mit Usercentrics dynamisch eingebunden werden. Bestimmte Komponenten werden im Checkout verwendet. Stimmt der Nutzer nicht zu, werden auch diese Komponenten nicht angezeigt und ein Bezahlung mit easyCredit ist nicht möglich.
